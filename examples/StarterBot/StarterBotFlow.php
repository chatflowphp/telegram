...
final class StarterBotFlow implements FlowInterface
{
    ...
    private static function phoneLabel(Context $ctx): string
    {
        ...
        $phone = $session->get('profile.phone');

        return is_string($phone) && $phone !== '' ? $phone : 'Not set';
    }
}
